/**************************************************************************/
/*! 
    @file     arduino-yun-lockitron-nfc
    @author   Alfredo Rius
    @license  BSD
...
/**** Other definitions ****/
#define TOTAL_SLOTS 64 // Arbitrary number of slots available (depends on the memory of your chip)
#define SLOT_SIZE 4
#define OPEN 0
#define CLOSE 1
...
void setup(void) {
  ...
  pinMode(RESET_MEMORY,INPUT_PULLUP);
